...
namespace MyFilmBevy.Controllers
{
    public class TempController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieId,Title,TagLine,Overview,RunTime,ReleaseDate,Rating,VoteAverage,PosterData,PosterType,BackdroprData,BackdropType,TrailerUrl")] Movie movie)
        {
